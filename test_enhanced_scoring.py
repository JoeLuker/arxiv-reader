    ...
    test_papers = [
        {
            ...
            'links': [{'href': 'http://arxiv.org/pdf/2023.12345.pdf', 'type': 'application/pdf'}]
        },
        {
            'id': '2023.67890',
            ...
            'links': [{'href': 'http://arxiv.org/pdf/2023.67890.pdf', 'type': 'application/pdf'}]
        },
        {
            'id': '2023.11111',
            ...
            'links': [{'href': 'http://arxiv.org/pdf/2023.11111.pdf', 'type': 'application/pdf'}]
        },
        {
            'id': '2023.22222',
            ...
            'links': [{'href': 'http://arxiv.org/pdf/2023.22222.pdf', 'type': 'application/pdf'}]
        },
        {
            'id': '2023.33333',
            ...
            'tags': [{'term': 'cs.AI'}, {'term': 'cs.LG'}],
            'links': [{'href': 'http://arxiv.org/pdf/2023.33333.pdf', 'type': 'application/pdf'}]
        }
    ]
...
def test_semantic_scoring():
    ...
    for i, paper in enumerate(papers):
        logger.info(f"{paper.id}: Semantic={semantic_batch_scores[i]:.3f}, TF-IDF={tfidf_batch_scores[i]:.3f}")
...
def test_citation_analysis():
    ...
    papers[0].summary += " This work builds on previous interpretability research including arXiv:2023.11111 and extends the methodology from arXiv:2023.33333."
    papers[2].summary += " Our probing approach is inspired by circuit analysis techniques from arXiv:2023.12345."
    papers[4].summary += " This paper references foundational work on attention mechanisms from arXiv:2023.11111."
...
def test_keyword_matching():
    ...
    papers = create_test_papers()
    scorer = RelevanceScorer(use_semantic=False, use_citations=False)  # Pure keyword matching
